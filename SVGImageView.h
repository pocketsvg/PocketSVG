...
/*!
 *  The SVG paths the view should draw.
 */
@property (nonatomic, copy) NSArray<SVGBezierPath*> *paths;

/*!
 *  A color to fill the SVG shape with.
 *
 *  @discussion Settig this property solidly fills the shape formed by the SVG path with the given color.
 */
@property(nonatomic, copy) IBInspectable PSVGColor *fillColor;


/*!
 *  The color to stroke the path with.
 *
